                    ...
                    <form class="container-form" method="post" action="quote-is-3.php" style="padding-bottom: 0">
                        ...
                        <fieldset id="returnAdd" style="margin: 0 0 40px; padding-bottom: 20px">
                            ...
                            <legend>Return Address</legend>
                                <!-- Full Name -->
                                <label>
                                    <input class="w3-light-gray" placeholder="Full Name (or Company):  *" name="name_reAdd"
                                           id="name" type="text" required>
                                </label>

                                <!-- Contact Name -->
                                <label>
                                    <input class="w3-light-gray" placeholder="Contact Name:  *" style="float: right;" name="contact_name_reAdd"
                                           id="contact_name" type="text" required>
                                </label>

                                <!-- Gender -->
                                <label>
                                    <select class="choice" name="gender_reAdd" required>
                                ...
                                <label>
                                    <input class="w3-light-gray" style="padding: 13px; float: right" placeholder="Title (Mr, Mrs, Dr. etc):   *"
                                           name="title_reAdd" type="text" required>
                                </label>

                                <!-- country codes (ISO 3166) and Dial codes. -->
                                <label>
                                    <select class="choice" name="countryCode_reAdd" id="">
                                ...
                                <!-- Telephone -->
                                <label>
                                    <input style="float: right; padding: 13px" class="w3-input w3-border-0 w3-light-gray" id="" name="phone_reAdd"
                                ...
                                <label>
                                    <input class="w3-light-gray" style="float: right" placeholder="Zip Code:  *"
                                           name="zip_code_reAdd" type="number" required>
                                </label>

                                <!-- Street Address -->
                                <label>
                                    <input class="w3-light-gray" style="width: 100%"
                                           placeholder="Street Address:  *" name="street_add_reAdd" type="text" required>
                                </label>

                                <!-- Street Address 2 (Apartment, suite, building) -->
                                <label>
                                    <input style="width: 100%" class="w3-input w3-border-0 w3-light-gray" name="street_add2_reAdd"
                                           placeholder="Street Address 2 (or Apartment, suite, etc.:  " type="text">
                                </label>

                                <!-- Department -->
                                <label>
                                    <input class="w3-input w3-border-0 w3-light-gray" name="department_reAdd"
                                           placeholder="Department, c/o, etc.: " type="text">
                                </label>

                                <!-- Email -->
                                <label>
                                    <input style="float: right" class="w3-input w3-border-0 w3-light-gray" name="email_reAdd"
                                           placeholder="Email:  *" type="email" required>
                                </label>

                                <!-- Residential Address -->
                                <label>
                                    <select  name="residential_reAdd" class="choice" required>
                                ...
                                <label>
                                    <select  style="float: right" name="notify" class="choice">
                                        <option value="0" selected="selected">Should we notify this person of return? </option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                </label>
