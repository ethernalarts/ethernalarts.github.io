<?php
  ...
  $gender = $_SESSION['gender'];
  $title_reAdd = $_SESSION['title'];
  $country_code_reAdd = $_SESSION['countryCode'];
  ...
  $street_add_reAdd = $_SESSION['street_add'];
  $add2_apt_reAdd = $_SESSION['street_add2'];
  $department_reAdd = $_SESSION['department'];
  $email_reAdd = $_SESSION['email'];
  $residen_add_reAdd = $_SESSION['residential_add'];
