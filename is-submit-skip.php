<?php
  ...
  $sql2 = "INSERT INTO return_address_IS (
    ...
    if (mysqli_query($link, $sql2)) {
        echo "Return Address Records added successfully.";
    } else {
    ...
    $sql3 = "INSERT INTO shipment_destination_IS (
      ...
      if (mysqli_query($link, $sql3)) {
          echo "Shipment Destination Records added successfully.";
      } else {
      ...
      $sql4 = "INSERT INTO shipment_dimensions_IS (
              `weight(pounds)`, `length(inches)`, `width(inches)`, `height(inches)`, `worth(USD)`, package_type, shipment_description
              ) VALUES (
