                ...
                <form class="container-form" method="post" style="padding-bottom: 0" action="quote-is-2.php">
                    ...
                    <fieldset style="margin: 0 0 20px; padding-bottom: 20px">
                        ...
                        <legend>Shipment Origin:</legend>
                            ...
                            <!-- Telephone -->
                            <label>
                                <input style="float: right; padding: 13px" class="w3-input w3-border-0 w3-light-gray" id="" name="phone"
                            ...
                            <label>
                                <input class="w3-light-gray" style="width: 100%"
                                       placeholder="Street Address:  *" name="street_add" type="text" required>
                            </label>
