          ...
          <div style="text-align:center; margin-bottom: 40px;">
            ...
            <div class="w3-card-quote-is">
                ...
                <form class="container-form" method="post" style="padding-bottom: 0">
                    ...
                    <fieldset style="padding-bottom: 20px; margin: 0 0 30px">
                        ...
                        <legend>Package Origin</legend>
                                ...
                                <label>
                                    <input disabled style="float: right" class="w3-input w3-border-0 w3-light-gray"
                                           placeholder="Contact Name: <?php echo $_SESSION['name_ec'] ?> ">
                                </label>
                    ...
                    <fieldset style="padding-bottom: 20px; margin: 0 0 30px">
                        ...
                        <legend>Return Address</legend>
                            ...
                            <label>
                                <input disabled style="float: right" class="w3-input w3-border-0 w3-light-gray"
                                       placeholder="Contact Name: <?php echo $_SESSION['name_ec_ra'] ?> ">
                            </label>
