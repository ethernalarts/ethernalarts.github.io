...
//        header("location: quote-is-3-skip.php");     //redirecting to third page
//    }
?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    <div class="wrap-input100 validate-input m-t-48 m-b-35">
                                        ...
                                        <textarea style="height: auto; padding-left: 0" class="input100" name="shipment_description" id="shipment_description"></textarea>
                                        <span class="focus-input100"></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <fieldset class="nofieldset" id="secondShipment" style="margin: 0 0 20px; display: none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12">
                                <div class="wrap-input100 validate-input m-t-48 m-b-35">
                                    <label for="shipment_description">Anything else we should know about your shipment?</label>
                                    <textarea style="height: auto; padding-left: 0" class="input100" name="shipment_description_2" id="shipment_description"></textarea>
                                    <span class="focus-input100"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <fieldset class="nofieldset" id="thirdShipment" style="margin: 0 0 20px; display: none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12">
                                <div class="wrap-input100 validate-input m-t-48 m-b-35">
                                    <label for="shipment_description">Anything else we should know about your shipment?</label>
                                    <textarea style="height: auto; padding-left: 0" class="input100" name="shipment_description_3" id="shipment_description"></textarea>
                                    <span class="focus-input100"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <fieldset class="nofieldset" id="fourthShipment" style="margin: 0 0 20px; display: none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12">
                                <div class="wrap-input100 validate-input m-t-48 m-b-35">
                                    <label for="shipment_description">Anything else we should know about your shipment?</label>
                                    <textarea style="height: auto; padding-left: 0" class="input100" name="shipment_description_4" id="shipment_description"></textarea>
                                    <span class="focus-input100"></span>
                                </div>
                            </div>
                        </div>
