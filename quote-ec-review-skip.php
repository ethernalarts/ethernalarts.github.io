                        ...
                        <legend>Return Address</legend>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['zipcode_ec'] ?>" id="zipcode_ec_ra">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['apt_ec'] ?>" id="apt_ec_ra">
                                </div>

                                <!-- Department -->
                                <div class="col-xs-12 col-sm-6">
                                    <label for="dept_ec_ra">Department, c/o, etc.</label>
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['dept_ec'] ?>" id="dept_ec_ra">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['resAdd_ec'] ?>" id="resAdd_ec_ra">
                                </div>
