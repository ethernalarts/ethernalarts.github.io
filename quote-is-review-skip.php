          ...
          <div style="text-align:center; margin-bottom: 40px;">
            ...
            <div class="w3-card-4">
                ...
                <form class="container-form" method="post" action="saveinfo-is-skip.php" style="padding-bottom: 0">
                        ...
                        <legend class="legend-middle" style="font-style: normal; margin-bottom: 20px">Shipment Origin Preview</legend>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <textarea disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['street_add'] ?>" id="street_add"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <textarea disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['street_add2'] ?>" id="street_add2"></textarea>
                                </div>
                            </div>
                    ...
                    <fieldset class="nofieldset" style="margin: 30px 0">
                        <legend class="legend-middle" style="font-style: normal; margin-bottom: 20px">In case nobody's home</legend>
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input disabled placeholder="<?php echo $_SESSION['name'] ?>" class="w3-light-gray" id="name_reAdd">
                                </div>

                                <!-- Contact's Name -->
                                <div class="col-xs-12 col-sm-6">
                                    <label for="contact_name_reAdd"> Contact's Name</label>
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['contact_name'] ?>" id="contact_name_reAdd">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['gender'] ?>" id="gender_reAdd">
                                </div>

                                <!-- Title -->
                                <div class="col-xs-12 col-sm-6">
                                    <label for="title_reAdd">Title</label>
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['title'] ?>" id="title_reAdd">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['phone'] ?>" id="phone_reAdd">
                                </div>

                                <!-- Email -->
                                <div class="col-xs-12 col-sm-6">
                                    <label for="email_reAdd">Email</label>
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['email'] ?>" id="email_reAdd">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['country'] ?>" id="countryId_reAdd">
                                </div>

                                <!-- State -->
                                <div class="col-xs-12 col-sm-6">
                                    <label for="stateId_reAdd">State</label>
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['state'] ?>" id="stateId_reAdd">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['city'] ?>" id="cityId_reAdd">
                                </div>

                                <!-- Zip Code -->
                                <div class="col-xs-12 col-sm-6">
                                    <label for="zip_code_reAdd">Zip Code</label>
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['zip_code'] ?>" id="zip_code_reAdd">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['street_add'] ?>" id="street_add_reAdd">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['street_add2'] ?>" id="street_add2_reAdd">
                                </div>

                                <!-- Department -->
                                <div class="col-xs-12 col-sm-6">
                                    <label for="department_reAdd">Department, c/o, etc.</label>
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['department'] ?>" id="department_reAdd">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input disabled class="w3-light-gray" placeholder="<?php echo $_SESSION['residential_add'] ?>" id="residential_reAdd">
                                </div>
                        ...
                        <legend class="legend-middle" style="font-style: normal; margin-bottom: 20px">Shipment Dimensions</legend>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <textarea disabled placeholder="<?php echo $_SESSION['other'] ?>" class="w3-light-gray" id="other"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <textarea disabled placeholder="<?php echo $_SESSION['shipment_description'] ?>" class="w3-light-gray" id="shipment_description"></textarea>
                                </div>
                            </div>
                                ...
                                <fieldset id="secondShipment" class="nofieldset" style="margin: 30px 0 10px; display: none">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <input disabled placeholder="<?php echo $_SESSION['shipment_type_2'] ?>" class="w3-light-gray" id="shipment_type_2">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12">
                                            ...
                                            <textarea disabled placeholder="<?php echo $_SESSION['other_2'] ?>" class="w3-light-gray" id="other_2"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12">
                                            ...
                                            <textarea disabled placeholder="<?php echo $_SESSION['shipment_description_2'] ?>" class="w3-light-gray" id="shipment_description_2"></textarea>
                                        </div>
                                    </div>
                                </fieldset>
                                  ...
                                  <legend class="legend-middle" style="font: normal 500 1.2em Roboto, sans-serif; margin: 20px auto">3rd Shipment Details</legend>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <input disabled placeholder="<?php echo $_SESSION['shipment_type_3'] ?>" class="w3-light-gray" id="shipment_type_3">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12">
                                            ...
                                            <textarea disabled placeholder="<?php echo $_SESSION['other_3'] ?>" class="w3-light-gray" id="other_3"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12">
                                            ...
                                            <textarea disabled placeholder="<?php echo $_SESSION['shipment_description_3'] ?>" class="w3-light-gray" id="shipment_description_3"></textarea>
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <legend class="legend-middle" style="font: normal 500 1.2em Roboto, sans-serif; margin: 20px auto">4th Shipment Details</legend>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <input disabled placeholder="<?php echo $_SESSION['shipment_type_4'] ?>" class="w3-light-gray" id="shipment_type_4">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12">
                                            ...
                                            <textarea disabled placeholder="<?php echo $_SESSION['other_4'] ?>" class="w3-light-gray" id="other_4"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12">
                                            ...
                                            <textarea disabled placeholder="<?php echo $_SESSION['shipment_description_4'] ?>" style="margin-bottom: 20px" class="w3-light-gray" id="shipment_description_4"></textarea>
                                        </div>
                                    </div>
                                </fieldset>
                    ...
                    <div class="w3-center">
                        <div style="padding-bottom: 30px" class="w3-bar">
