...
<head>
    ...
    <title>VLink Express Courier - Get a Quote (Domestic Shipping - Complete)</title>
                ...
                <div class="container-form" style="padding: 0">
                    <div >
                        <p class="success-message">
                            <span style="font: italic 600 1.03em 'Quicksand Medium', serif">
                                <?php echo $_SESSION['title_ec'] ?>. <?php echo $_SESSION['name_ec'] ?>,
                            </span><br>
                            We have received your Domestic Shipping order.<br>
                    ...
                    <div class="w3-center">
                        <div class="w3-bar"style="padding-top: 0">
                            <a href="getaquote.html" class="tryagain">
                                Get Another Quote</a>
                        </div>
                    </div>
                </div>
